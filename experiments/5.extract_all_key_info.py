    ...
    for dataset_main, (dataset_subs, filename_prefix_pattern) in datasets.items():
        for dataset_sub in dataset_subs:
            ...
            for model in llm_models:
                ...
                input_filename = f"{filename_prefix}_no_RAG_c3_log_template_new_context_back_llm_tune9_all_{model}.log"
                ...
                output_filename = f"{filename_prefix}_no_RAG_c3_log_template_new_context_back_llm_tune9_all_{model}_extracted_tasks_info.md"
