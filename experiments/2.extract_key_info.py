...
def extract_task_info(input_file):
    ...
    # 匹配需要提取的行
    # token_pattern = re.compile(r'\|\s*INFO\s+\|\s*rca\.api_router:AI_chat_completion:\d+\s*-\s*==llama3.1:8b-instruct-q8_0=====================input Tokens:')
    token_pattern = re.compile(r'\|\s*INFO\s+\|\s*rca\.api_router:AI_chat_completion:\d+\s*-\s*==claude-3-5-sonnet-20241022=====================input Tokens:')
...
if __name__ == '__main__':
    input_path = '/root/shared-nvme/work/agent/OpenRCA/experiments/Bank/claude-3-5-sonnet-20241022/Bank_all_RAG_claude-3-5-sonnet-20241022.log'
    output_path = '/root/shared-nvme/work/agent/OpenRCA/experiments/Bank/claude-3-5-sonnet-20241022/Bank_all_RAG_claude-3-5-sonnet-20241022_extracted_tasks_info.md'
